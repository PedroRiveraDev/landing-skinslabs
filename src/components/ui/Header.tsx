        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    ...
                    {/* Botón Menú Móvil */}
                    <button
                        className={`md:hidden p-2 rounded-lg ${isLanding ? 'hover:bg-slate-100' : 'hover:bg-slate-800'} ${textColor} focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 focus:ring-offset-transparent`}
